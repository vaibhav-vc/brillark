...
**Category:** `orchestration` · **Output artifact:** `scorecard.md`
...
## Output contract
Write `scorecard.md` into `workspace/<venture-id>/orchestration/`, then register it as an artifact record
(`knowledge-schema/artifact.schema.json`) so it becomes retrievable memory. Every output carries:

```markdown
# <title>
- **Skill:** weekly-scorecard
